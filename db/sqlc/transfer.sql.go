...
SELECT id, from_account_id, to_account_id, amount, created_at FROM transfers WHERE from_account_id=$1 or to_account_id = $2  ORDER BY create_at LIMIT $3 OFFSET $4
`

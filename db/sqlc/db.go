...
func Prepare(ctx context.Context, db DBTX) (*Queries, error) {
	q := Queries{db: db}
	var err error
	if q.addAccountBalaneStmt, err = db.PrepareContext(ctx, addAccountBalane); err != nil {
		return nil, fmt.Errorf("error preparing query AddAccountBalane: %w", err)
	}
	...
	if q.deleteAcccountStmt, err = db.PrepareContext(ctx, deleteAcccount); err != nil {
		return nil, fmt.Errorf("error preparing query DeleteAcccount: %w", err)
	}
...
func (q *Queries) Close() error {
	var err error
	if q.addAccountBalaneStmt != nil {
		if cerr := q.addAccountBalaneStmt.Close(); cerr != nil {
			err = fmt.Errorf("error closing addAccountBalaneStmt: %w", cerr)
		}
	}
	...
	if q.deleteAcccountStmt != nil {
		if cerr := q.deleteAcccountStmt.Close(); cerr != nil {
			err = fmt.Errorf("error closing deleteAcccountStmt: %w", cerr)
		}
	}
